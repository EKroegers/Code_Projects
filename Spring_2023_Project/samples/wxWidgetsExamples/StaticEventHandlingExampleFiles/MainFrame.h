...
private: 
    ...
    //we have to bind event handler to the buttons event before anything can happen so we have to make an Event Table
    //must invoke this macro which is then further used in the implamentation file. 

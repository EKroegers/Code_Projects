...
feats. This includes the name of the feat (featTitle), the description of the 
...
= 1.1.0 =
* Changed the featBenefits field from a TextControl element to a TextareaControl
for better ease of use in the editor panel
